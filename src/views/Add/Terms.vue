    ...
    <div class="contributor">
      <div id="check">
        ...
        <div class="add-buttons">
          ...
          <a href="#" class="button linkedin twiiter w-button">Add via <span class="text-span-7"> Coming Soon </span></a>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    oauth(provider) {
      axios.get(`https://bavatar.herokuapp.com/api/auth/redirect?provider=${provider}`)
        .then((res) => {
          console.log(res);
        });
    },
